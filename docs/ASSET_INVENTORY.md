...
| `assets/audio/sfx_explosion_small.wav/.ogg` | **REAL BOMBING — Pixabay explosion-109420** (66K MP3 24kHz, real explosion) | https://cdn.pixabay.com/download/audio/2021/08/04/audio_0625c1539c.mp3?filename=explosion-109420.mp3 (Pixabay) — mirrored via `test_pixabay_explosion.mp3` | Pixabay Content License (free commercial, no attribution) | No | 2026-09-01 | PASS | Real bombing 0.61s, highpass 40 lowpass 8k loudnorm -10 |
